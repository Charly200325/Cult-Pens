    ...
    (function( jQuery ){
  var $module = jQuery('#m-1683292980137').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1683292980137"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1683292980137", options);
