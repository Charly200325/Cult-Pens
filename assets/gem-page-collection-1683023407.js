  ...
  try {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1721734014100').children('.module');
  ...
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1721734017640').children('.module');
  $module.gfV2HeroBanner({});
  ...
  try {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1721737437050').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1721737437050-0').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1721737437050-2').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1683026000011').children('.module');
  $module.gfV2HeroBanner({});
  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1721737584826').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1721737584826-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1721737584826-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1683027416554').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1683027416554"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1683027416554", options);
