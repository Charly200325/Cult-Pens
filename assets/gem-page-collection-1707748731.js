    ...
    (function( jQuery ){
  var $module = jQuery('#m-1707752765850').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1707752765850"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1707752765850", options);
  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1714122818885').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1714122818885-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1714122818885-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1714122821104').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1714122821104-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1714122821104-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1714122858623').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1714122858623-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1714122858623-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1707754371233').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1708697723416').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
