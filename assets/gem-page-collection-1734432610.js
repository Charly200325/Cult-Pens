    ...
    (function( jQuery ){
  var $module = jQuery('#m-1734433586297').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1734433586297"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1734433586297", options);
