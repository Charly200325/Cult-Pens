  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1681798384662').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1681798384662"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1681798384662", options);
